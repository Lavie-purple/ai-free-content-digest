...
共 **10 期**（2026-09-14 ~ 2026-09-21），Markdown 合计 **455560 B ≈ 445 KB**。
...
- **信源分级台账** `AI信息源分级清单-T0-T4.md`：189 条（T0 101 / T1 19 / T2 18 / T3 36 / T4 15）
- **截止时间表** `.workbuddy/data/deadlines.csv`：58 条（由 `extract_deadlines.py` 从最新一期重建）
