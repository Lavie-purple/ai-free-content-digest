...
共 **11 期**（2026-09-14 ~ 2026-09-22），Markdown 合计 **582243 B ≈ 569 KB**。
...
- **信源分级台账** `AI信息源分级清单-T0-T4.md`：193 条（T0 102 / T1 19 / T2 18 / T3 37 / T4 17）
- **截止时间表** `.workbuddy/data/deadlines.csv`：75 条（由 `extract_deadlines.py` 从最新一期重建）
