...
共 **9 期**（2026-09-14 ~ 2026-09-20），Markdown 合计 **365520 B ≈ 357 KB**。
...
- **信源分级台账** `AI信息源分级清单-T0-T4.md`：185 条（T0 98 / T1 19 / T2 18 / T3 36 / T4 14）
- **截止时间表** `.workbuddy/data/deadlines.csv`：52 条（由 `extract_deadlines.py` 从最新一期重建）
